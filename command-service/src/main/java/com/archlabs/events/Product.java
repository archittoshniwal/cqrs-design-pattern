...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 9100285516520508565L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"com.archlabs.events\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"description\",\"type\":\"string\"},{\"name\":\"price\",\"type\":\"double\"}]}");
   ...
   */
  public Product(java.lang.Long id, java.lang.CharSequence name, java.lang.CharSequence description, java.lang.Double price) {
    this.id = id;
    this.name = name;
   ...
   */
  public static com.archlabs.events.Product.Builder newBuilder() {
    return new com.archlabs.events.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.archlabs.events.Product.Builder newBuilder(com.archlabs.events.Product.Builder other) {
    if (other == null) {
      return new com.archlabs.events.Product.Builder();
    } else {
      return new com.archlabs.events.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.archlabs.events.Product.Builder newBuilder(com.archlabs.events.Product other) {
    if (other == null) {
      return new com.archlabs.events.Product.Builder();
    } else {
      return new com.archlabs.events.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.archlabs.events.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.archlabs.events.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.archlabs.events.Product.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.archlabs.events.Product.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.archlabs.events.Product.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.archlabs.events.Product.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.archlabs.events.Product.Builder setDescription(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.archlabs.events.Product.Builder clearDescription() {
      description = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.archlabs.events.Product.Builder setPrice(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.archlabs.events.Product.Builder clearPrice() {
